...
export class MyTaskService {
  ...
  AssignToUser(ApplicationNo:any, todoid:any, status:any, EmpID:any, taskid:any, username: any) {
    return this.http.post(this.AssignToUserUrl + '?ApplicationNo=' + ApplicationNo + '&todoid=' + todoid
      + '&userName=' + username + '&status=' + status + '&EmpID=' + EmpID + '&taskid=' + taskid, null);
  }
