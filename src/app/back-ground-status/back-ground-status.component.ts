...
export class BackGroundStatusComponent {
  ...
  constructor(private _formBuilder: FormBuilder,private http: HttpClient,
    ...
    this.backgroundForm = new FormGroup({
      ...
      occupational_responsibility: new FormControl(),
      working_organization: new FormControl(),
      experience: new FormControl(),      
      skill: new FormControl(),
      volunteer_experience: new FormControl()
    });
  }
  ngOnInit() {
...
if(res.procBackground_statuss[0].education_status=='professional'){
  ...
  this.isProfession = false
      ...
      this.backgroundForm.patchValue({
        ...
        Profession: res.procBackground_statuss[0].Profession,
...
console.log('testttttt',this.dataArray);
  ...
  getcontry(){
    this.service.getcontry().subscribe((res:any) =>{
      ...
      console.log(res.procCountrys[0].name,'res');
  ...
  save(){
    ...
    this.service.insertBackstat_data(this.Background_status).subscribe((res:any)=>{
      this.service.insertLang(this.dataArray[0]).subscribe((res:any)=>{
